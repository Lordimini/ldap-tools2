        ...
        try:
            ...
            # Gérer la recherche d'un seul utilisateur
                ...
                result = {
                    ...
                    'FavvHierarMgrDN': getattr(user_attributes, 'FavvHierarMgrDN', {}).value if hasattr(user_attributes, 'FavvHierarMgrDN') else '',
                    'FavvExtDienstMgrDn': getattr(user_attributes, 'FavvExtDienstMgrDn', {}).value if hasattr(user_attributes, 'FavvExtDienstMgrDn') else '',
                    'nrfMemberOf': [],
                    ...
                    'telephoneNumber': getattr(user_attributes, 'telephoneNumber', {}).value if hasattr(user_attributes, 'telephoneNumber') else '',
                    ...
                    'pwmResponseSet': getattr(user_attributes, 'pwmResponseSet', {}).value if hasattr(user_attributes, 'pwmResponseSet') else '',
